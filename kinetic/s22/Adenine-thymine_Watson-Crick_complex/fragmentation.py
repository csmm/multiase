#THIS SCRIPT CALCULATES THE FRAGMENTATION ENERGY OF MOLECULES (organic)
...
MOL = ['Adenine-thymine_Watson-Crick_complex']

#Introduce the different atoms that are in the molecules:
ATO = ['Adenine-thymine_Watson-Crick_complex_f1','Adenine-thymine_Watson-Crick_complex_f2']
...
def run_per_element(element):
    ...
    print ' '
    print '%%%%%%%%%%%% FRAGMENTATION ENERGY OF %s MOLECULE %%%%%%%%%%%%' % element
    print ' '
